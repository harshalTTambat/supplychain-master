...
public class SupplyChain extends Application {
    ...
    private Pane headerBar(){
        ...
        searchButton.setTranslateX(searchEnd+ 20);
        ...
        loginButton.setTranslateX(searchEnd+100);
        loginButton.setTextFill(Paint.valueOf("red"));
        ...
        welcomeUser.setTranslateX(searchEnd + 150);
